...
describe("put /public/mydetail", () => {
  it("should return 404 status code when customer doesn't have detail", async () => {
    ...
    expect(response.body).toMatchObject({message: "You don't have detail yet, please create one"})
  });
});
